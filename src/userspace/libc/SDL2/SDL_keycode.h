...
/* Editing / system keys */
#define SDLK_CLEAR        SDL_SCANCODE_TO_KEYCODE(156)
#define SDLK_MODE         SDL_SCANCODE_TO_KEYCODE(257)
#define SDLK_HELP         SDL_SCANCODE_TO_KEYCODE(117)
#define SDLK_SYSREQ       SDL_SCANCODE_TO_KEYCODE(154)
#define SDLK_MENU         SDL_SCANCODE_TO_KEYCODE(118)
#define SDLK_POWER        SDL_SCANCODE_TO_KEYCODE(102)
#define SDLK_UNDO         SDL_SCANCODE_TO_KEYCODE(122)
#define SDLK_APPLICATION  SDL_SCANCODE_TO_KEYCODE(101)
#define SDLK_PERCENT      '%'
#define SDLK_DOLLAR       '$'
#define SDLK_HASH         '#'
#define SDLK_AT           '@'
...
/* Multimedia / consumer keys (stubs — never produced on potatOS) */
#define SDLK_SLEEP            SDL_SCANCODE_TO_KEYCODE(282)
#define SDLK_MUTE             SDL_SCANCODE_TO_KEYCODE(127)
#define SDLK_VOLUMEUP         SDL_SCANCODE_TO_KEYCODE(128)
#define SDLK_VOLUMEDOWN       SDL_SCANCODE_TO_KEYCODE(129)
#define SDLK_EJECT            SDL_SCANCODE_TO_KEYCODE(281)
#define SDLK_WWW              SDL_SCANCODE_TO_KEYCODE(264)
#define SDLK_MAIL             SDL_SCANCODE_TO_KEYCODE(265)
#define SDLK_CALCULATOR       SDL_SCANCODE_TO_KEYCODE(266)
#define SDLK_CUT              SDL_SCANCODE_TO_KEYCODE(123)
#define SDLK_COPY             SDL_SCANCODE_TO_KEYCODE(124)
#define SDLK_PASTE            SDL_SCANCODE_TO_KEYCODE(125)
#define SDLK_SELECT           SDL_SCANCODE_TO_KEYCODE(119)
#define SDLK_CANCEL           SDL_SCANCODE_TO_KEYCODE(155)
#define SDLK_AC_SEARCH        SDL_SCANCODE_TO_KEYCODE(269)
#define SDLK_AC_HOME          SDL_SCANCODE_TO_KEYCODE(270)
#define SDLK_AC_BACK          SDL_SCANCODE_TO_KEYCODE(271)
#define SDLK_AC_FORWARD       SDL_SCANCODE_TO_KEYCODE(272)
#define SDLK_AC_STOP          SDL_SCANCODE_TO_KEYCODE(273)
#define SDLK_AC_REFRESH       SDL_SCANCODE_TO_KEYCODE(274)
#define SDLK_AC_BOOKMARKS     SDL_SCANCODE_TO_KEYCODE(275)
#define SDLK_AUDIONEXT        SDL_SCANCODE_TO_KEYCODE(258)
#define SDLK_AUDIOPREV        SDL_SCANCODE_TO_KEYCODE(259)
#define SDLK_AUDIOSTOP        SDL_SCANCODE_TO_KEYCODE(260)
#define SDLK_AUDIOPLAY        SDL_SCANCODE_TO_KEYCODE(261)
#define SDLK_AUDIOMUTE        SDL_SCANCODE_TO_KEYCODE(262)
#define SDLK_AUDIOREWIND      SDL_SCANCODE_TO_KEYCODE(285)
#define SDLK_AUDIOFASTFORWARD SDL_SCANCODE_TO_KEYCODE(286)
